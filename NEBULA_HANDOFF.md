...
### 5. Synthesis (The Meaning)
- **Status:** **[DONE]** (Agent 9)
- **Implementation:**
    - `NebulaField` component clusters stars visually.
    - AI Synthesis (`synthesizeCluster` action) generates titles/summaries.
    - `NebulaSynthesisModal` displays results with "Fly To" navigation.
    - Toggle visibility added for clarity.

### 6. Refinement
- **Status:** **[TODO]**
- **Goal:** Polish the experience.
- **Ideas:**
    - **Physics:** Add gravity between nodes?
